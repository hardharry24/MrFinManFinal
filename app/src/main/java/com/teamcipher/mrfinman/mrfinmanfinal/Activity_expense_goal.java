...
public class Activity_expense_goal extends AppCompatActivity implements View.OnClickListener {
    ...
    private void txtImageFunctions() {
        txtImgreceipt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                methods.vibrate(ctx);
                ImagePicker.pickImage(Activity_expense_goal.this, "Select image receipt:");
            }
        });
        ...
        imgReciept.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final Dialog dialog = new Dialog(Activity_expense_goal.this);
    ...
    private void onEdit() {
        try
        {
            if (bundle != null )
            {
                ...
                txtamount.setText(""+methods.formatter.format(Double.parseDouble(bundle.getString("amount"))));
    ...
    private void showCalendar() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(Activity_expense_goal.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT,mdatelistener,year,month,day);
        dialog.show();
    }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, methods.server()+"getUserCategory.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    adapter = new CategoryGridviewAdapter(Activity_expense_goal.this,categories);
    ...
    private void initialization() {
        ...
        ctx = Activity_expense_goal.this;
                                        ...
                                        if (!(Double.parseDouble(amt) <= 10))
                                        {
                                            if (SavingSingleton.getInstance().getAllSavings() >= Double.parseDouble(amt))
                                            {
                                                ...
                                                alertDialogBuilder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                                                    @Override
                                                    public void onClick(DialogInterface dialogInterface, int i) {
                                                        Toast.makeText(Activity_expense_goal.this, "Canceled!", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                                alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                                    @Override
                                                ...
                                                Toast.makeText(Activity_expense_goal.this, "Not enough savings! ", Toast.LENGTH_SHORT).show();
                                        }
                                        else
                                            Toast.makeText(Activity_expense_goal.this, "Minimum amount to be borrow is Php 10.00!", Toast.LENGTH_SHORT).show();
                                    }else
                ...
                try {
                    ...
                    if (nPrevSelGridItem == position) {
                        ...
                        if (categories.get(position).getId() != 0) {
                            ...
                            Alerter.create(Activity_expense_goal.this).setTitle("Category").setBackgroundColorRes(R.color.gray).setIcon(R.drawable.ic_done).setText(categoryNameSelected + "").show();
                        }
                        else
                        {
                            selectedID = -1;
    ...
    {
        progressDialog = new ProgressDialog(Activity_expense_goal.this);
    ...
    {
        budgetType = customMethod.getPreference(Activity_expense_goal.this, username, "budgetType");
        String dt = "";
        SimpleDateFormat month = new SimpleDateFormat("MM/yyyy");
        if (!TextUtils.isEmpty(budgetType))
        {
            budgetAmount = Double.parseDouble(customMethod.getPreference(Activity_expense_goal.this, username, "budgetAmount"));
    ...
    private void UpdateExpense()
    {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, methods.server()+"update_Expense.php", new Response.Listener<String>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Alerter.create(Activity_expense_goal.this).setText("NO INTERNET CONNECTION!\n")
                        .setIcon(R.drawable.ic_info_outline_black_24dp)
                        .show();
            }
        }){
